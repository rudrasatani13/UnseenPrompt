/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv` (hash: 7353f86435f2324c7d9d38f1210c444c)
...
interface __BaseEnv_CloudflareEnv {
  ...
  NEXT_PUBLIC_APP_URL:
    | "https://preview.unseenprompt.com"
    | "https://unseenprompt-staging.rudrasatani.workers.dev"
    | "https://unseenprompt.com"
    | "http://127.0.0.1:8787";
  RELEASE_SHA: "preview" | "staging" | "production" | "local";
  MAINTENANCE_MODE: "off";
  HEALTHCHECK_TOKEN?: string;
  RUNTIME_HEALTH_WORKFLOW?: Workflow<
    Parameters<import("./custom-worker").RuntimeHealthWorkflow["run"]>[0]["payload"]
  >;
