/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv` (hash: 35a08e6f23234c9ee5aef30eb8c4f174)
// Runtime types generated with workerd@1.20260722.1 2026-07-27 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_CloudflareEnv {
	CF_VERSION_METADATA: WorkerVersionMetadata;
	ASSETS: Fetcher;
	APP_ENV: "preview" | "staging" | "production" | "local";
	NEXT_PUBLIC_APP_URL: "https://preview.unseenprompt.com" | "https://unseenprompt-staging.rudrasatani.workers.dev" | "https://unseenprompt.com" | "http://127.0.0.1:8787";
	RELEASE_SHA: "preview" | "staging" | "production" | "local";
	...
	RUNTIME_HEALTH_WORKFLOW?: Workflow<Parameters<import("./custom-worker").RuntimeHealthWorkflow['run']>[0]['payload']>;
	WAITLIST_RATE_LIMITER?: RateLimit;
	NEXT_PUBLIC_TURNSTILE_SITE_KEY?: "0x4AAAAAAEA6pueCMCfbUmae";
	SUPABASE_URL?: "https://tbhwcasvyfvqvdwcmdvx.supabase.co";
...
declare namespace Cloudflare {
	...
	interface StagingEnv {
		...
		ASSETS: Fetcher;
		APP_ENV: "staging";
		NEXT_PUBLIC_APP_URL: "https://unseenprompt-staging.rudrasatani.workers.dev";
		RELEASE_SHA: "staging";
		MAINTENANCE_MODE: "off";
		HEALTHCHECK_TOKEN: string;
		ANTHROPIC_API_KEY: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ENV" | "NEXT_PUBLIC_APP_URL" | "RELEASE_SHA" | "MAINTENANCE_MODE" | "HEALTHCHECK_TOKEN" | "ANTHROPIC_API_KEY" | "OPENAI_API_KEY" | "GEMINI_API_KEY" | "OPENCODE_API_KEY" | "SUPABASE_SECRET_KEY" | "NEXT_PUBLIC_TURNSTILE_SITE_KEY" | "SUPABASE_URL" | "WAITLIST_FROM_EMAIL" | "TURNSTILE_SECRET_KEY" | "RESEND_API_KEY" | "WAITLIST_TOKEN_SECRET">> {}
}
