...
/**
 * An alert dialog has no dismiss affordance of its own: the consumer must supply
 * an explicit cancel and an explicit confirm. Acknowledgement is never implied.
 */
