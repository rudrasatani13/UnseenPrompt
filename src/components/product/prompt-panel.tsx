  ...
  return (
    <Card data-slot="prompt-panel" className="w-full max-w-[800px]">
      ...
      <CardContent className="grid gap-4">
        ...
        <section className="grid gap-2">
          <h2 id="prompt-panel-acceptance" className="text-sm font-semibold text-ink">
            Acceptance criteria
          </h2>
          <ul aria-labelledby="prompt-panel-acceptance" className="grid gap-2 text-sm text-ink">
